...
import {ChatroomNavigationWarningComponent, RecipeListComponent, SearchBarComponent} from './recipe-list';
...
@NgModule({
  ...
  declarations: [
    ...
    ChatroomNavigationWarningComponent
  ],
  entryComponents: [ChatroomNavigationWarningComponent]
})
