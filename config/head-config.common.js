 ...
 *
 * { rel: 'apple-touch-icon', sizes: '57x57', href: '/assets/icon/apple-icon-57x57.png', '=href':
 * false }, Will not prefix the publicPath on href (href attributes are added by default
 *
 */
module.exports = {
  script: [{
    src:
        'https://cdnjs.cloudflare.com/ajax/libs/javascript-canvas-to-blob/3.7.0/js/canvas-to-blob.min.js',
    integrity: 'sha256-XbyfygpFYbW5Qxe5xPOj+hSWfd84KNkc4/jAX2EHfwY=',
  ...
  link: [
    ...
    /** <link> tags for material design icons **/
